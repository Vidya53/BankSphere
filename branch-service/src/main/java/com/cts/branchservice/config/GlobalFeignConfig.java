...
/**
 * Propagates auth + correlation headers on every outbound Feign call so
 * downstream services see the same X-User-Id / X-Role / correlation id as
 * the incoming request to this service.
 */
@Configuration
@Slf4j
