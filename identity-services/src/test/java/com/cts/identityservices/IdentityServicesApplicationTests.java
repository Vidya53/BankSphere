 ...
 *   - Mail server (SMTP) for password-reset OTPs
 *
 ...
 */
@SpringBootTest
@Disabled("Full context load requires MySQL / Mail / Config Server / Eureka. Run via `mvn test -Dgroups=integration` once infra is available.")
